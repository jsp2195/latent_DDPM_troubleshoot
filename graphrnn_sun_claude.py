    ...
    for i, data in enumerate(train_loader):
        try:
            ...
            torch.save({
                ...
                'hidden_projection_state': hidden_projection.state_dict(),
...
if os.path.exists(node_model_path) and os.path.exists(edge_model_path) and os.path.exists(state_checkpoint_path):
    ...
    if 'hidden_projection_state' in checkpoint:
        hidden_projection.load_state_dict(checkpoint['hidden_projection_state'])
